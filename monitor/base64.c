...
int main(int argc,char *argv[]){
    char *base64Char = "aHR0cDovL3Bpbmx2LmFtY2hpcy5jb20vbWhzeV93ZWIvbGVpeGluZy95aW5waW4xLm1wMy50YXIuZ3o=";
    long base64CharSize = 80;
    char *originChar = "";
    long originCharSize = 1024;
    decode(base64Char,base64CharSize,originChar,originCharSize)
    return 0
}